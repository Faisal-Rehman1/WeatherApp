...
//        for not show status bar or shows full screen
    ...
    private void getWeatherInfo(String cityName) {
        String url = "http://api.weatherapi.com/v1/forecast.json?key=58cef06a7b154aa791b74329210210&q="+ cityName +"&days=1&aqi=yes&alerts=yes";
        cityNameTV.setText(cityName);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (isDay == 1) {
                        ...
                        // Night Image
                        Picasso.get().load("https://unsplash.com/photos/Afmo1_1qfeU").into(backIV);
                    }
